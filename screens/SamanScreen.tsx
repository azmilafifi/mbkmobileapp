...
import CheckComponent from '../src/components/CheckComponent';
import DiscountComponent from '../src/components/DiscountComponent';
import HistoryComponent from '../src/components/HistoryComponent';
import PayComponent from '../src/components/PayComponent';
...
const HomeScreen = () => {
  ...
  const [selectedSection, setSelectedSection] = useState('pay'); // Default selection is 'pay'
